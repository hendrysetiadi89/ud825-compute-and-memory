...
public class CachingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theButtonThatDoesFibonacciStuff2.setText("Compute some Fibonacci numbers (optimized).");
        ...
        theButtonThatDoesFibonacciStuff2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Compute the 40th number in the fibonacci sequence, then dump to log output. Note
                // how the UI hangs each time you do this.
                Log.i(LOG_TAG, String.valueOf(computeFibonacci2(40)));
            }
        });
    ...
    public int computeFibonacci2(int positionInFibSequence) {
        int prev = 0;
        int current = 1;
        int newValue;
